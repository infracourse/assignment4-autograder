...
if len(tags) != 2 or "123456789123.dkr.ecr.us-west-2.amazonaws.com/cs40:latest" not in tags or not "123456789123.dkr.ecr.us-west-2.amazonaws.com/cs40:1709649832" in tags:
    print("Step 6 tags are malformed")
if not steps[6]["run"].strip().startswith("aws ecr batch-delete-image") or "imageTag=latest" not in steps[6]["run"]:
